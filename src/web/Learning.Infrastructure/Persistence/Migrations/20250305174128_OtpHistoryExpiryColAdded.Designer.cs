...
namespace Learning.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250305174128_OtpHistoryExpiryColAdded")]
    partial class OtpHistoryExpiryColAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Learning.Domain.Identity.OtpHistory", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("NextOtpAfter")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Learning.Domain.Notification.ModelExamOrder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("RzrpayOrderId")
                        .HasMaxLength(40)
            ...
            modelBuilder.Entity("Learning.Domain.Notification.ModelExamPurchaseHistory", b =>
                {
                    b.HasOne("Learning.Domain.Notification.ModelExamOrder", "ModelExamOrder")
                        .WithOne("ModelExamPurchaseHistory")
                        .HasForeignKey("Learning.Domain.Notification.ModelExamPurchaseHistory", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ModelExamOrder");
                });
            ...
            modelBuilder.Entity("Learning.Domain.Notification.ModelExamOrder", b =>
                {
                    b.Navigation("ModelExamPurchaseHistory");
                });
